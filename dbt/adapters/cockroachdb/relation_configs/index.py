...
class CockroachdbIndexMethod(StrEnum):
    btree = "btree"
    hash = "hash"
    gist = "gist"
    spgist = "spgist"
    ...
    @classmethod
    def default(cls) -> "CockroachdbIndexMethod":
        return cls.btree


@dataclass(frozen=True, eq=True, unsafe_hash=True)
class CockroachdbIndexConfig(RelationConfigBase, RelationConfigValidationMixin):
    """
    ...
    method: CockroachdbIndexMethod = field(default=CockroachdbIndexMethod.default(), hash=True)
    ...
    @classmethod
    def from_dict(cls, config_dict) -> "CockroachdbIndexConfig":
        ...
        index: "CockroachdbIndexConfig" = super().from_dict(kwargs_dict)  # type: ignore
        return index
...
@dataclass(frozen=True, eq=True, unsafe_hash=True)
class CockroachdbIndexConfigChange(RelationConfigChange, RelationConfigValidationMixin):
    """
    ...
    context: CockroachdbIndexConfig
