...
logger = AdapterLogger("Cockroachdb")
...
class CockroachdbConnectionManager(SQLConnectionManager):
    ...
    def open(cls, connection):
        ...
        kwargs = {}
        # we don't want to pass 0 along to connect() as cockroachdb will try to
        ...
        if search_path is not None and search_path != "":
            # see https://cockroachdbql.org/docs/9.5/libpq-connect.html
